    ...
    if (Shop == 0){
        ...
        MainCanvas.onclick = function(e) { // обрабатываем клики мышью
            ...
            if (!collision(x,y,500,200,200,500)){
                ...
                if (collision(x,y,500,290,200,60)){
                    //Ром
                    if (coins>4){
                        add("Ром")
                        coins-=4
                    }else{
                        alert("На ром денег не хватает")
                    }
                }
                else if (collision(x,y,500,360,200,60)){
                    //Эль
                    if (coins>5){
                        add("Медовуха")
                        coins-=6
                    }else{
                        alert("На медовуху денег не хватает")
                    }
                }
                else if (collision(x,y,500,430,200,60)){
                    //Медовуха
                    if (coins>6){
                        add("Эль")
                        coins-=5
                    }else{
                        alert("На эль денег не хватает")
                    }   
                }
                updateInv()
            }
    ...
    if (Shop == 1){
        ...
        MainCanvas.onclick = function(e) { // обрабатываем клики мышью
            ...
            if (!collision(x,y,300,50,500,600)){
                ...
                if (PlayerDiceCell==1){
                    j = confirm("Хочешь новую одежку? Всего за 18 монет ты сможешь носить с собой 2 кубика!")
                    if (j&&coins>=18){
                        PlayerDiceCell+=1
                        coins-=18
                    }
                }else if (PlayerDiceCell==2){
                    j = confirm("О, да вы красивы, хотите дворянскую одежду с возможностью носить 3 кубика? Всего за 50 монет!")
                    if (x&&coins>=50){
                        PlayerDiceCell+=1
                        coins-=50
                    }
                }else{
                    alert("Извините, выше класса чем у вас одежды у нас нету")
                }
                updateInv()
            }
        };
...
function DiceGame(game){
    ...
    let g = new Image()
    let n = new Image()
    r.src = "img/board/-1.png"
    n.src = "img/board/0.png"
    g.src = "img/board/1.png"
    function DrawRoundIndicator(){
        ...
        if (roundsRes[0]==-1){
            ctx.drawImage(r,725,605)
        }else if (roundsRes[0]==0){
            ctx.drawImage(n,725,605)
        }else if (roundsRes[0]==1){
            ctx.drawImage(g,725,605)
        }

        if (roundsRes[1]==-1){
            ctx.drawImage(r,805,605)
        }else if (roundsRes[1]==0){
            ctx.drawImage(n,805,605)
        }else if (roundsRes[1]==1){
            ctx.drawImage(g,805,605)
        }

        if (roundsRes[2]==-1){
            ctx.drawImage(r,885,605)
        }else if (roundsRes[2]==0){
            ctx.drawImage(n,885,605)
        }else if (roundsRes[2]==1){
            ctx.drawImage(g,885,605)
        }
    ...
    function drawDiceGame(){
        ...
        DiceCell2X = 1150
        DiceCell2Y = 33
        ctx.fillStyle="rgba(250,240,220,0.2)"
        ...
        ctx.fillStyle="rgba(220,200,200,0.2)"
        for (i=0;i<5;i++){
            ...
            if (collision(x,y,235,210,810,300)){
                ...
                if (round == 0){
                    ...
                    if (DjoFirst){
                        ...
                        CurrentDialog = [{txt:"Бросай кости!", name:"Пьяный Джо"}]
                        isDialog=true
                        InGameDialog()
                    }
                    ...
                    if (DjoFirst){
                        ...
                        {txt:"А ты кубики перебрасывай! Видишь если число маленькое выпало так ты жми на него, если повезёт то побольше выпадет, на все воля случая! Хе-хе... И это... Спаивай врагов! Всегда носи с собой пойло, у нас в Костянске никто от него не отказывается, если напоишь то победишь. А как деньги появятся ты костюмчик прикупи, кубиков больше носить сможешь.", name:"Пьяный Джо"},]             
                        isDialog=true
                        setTimeout(InGameDialog, 10);
                        DjoFirst=false
                    }
                    ...
                    if (currentScene==9&&coins>3){
                        ...
                        alert("Чтобы перейти на следующий этап предется накопить сумму денег")
                    }
            ...
            if (collision(x,y,235,210,810,300)){
                ...
                if (round == 0){
                    ...
                    if (filFirst){
                        ...
                        CurrentDialog = [{txt:"Ну что, бросаем кости!",name:"Просто Фил"}]
                    }
                    isDialog=true
                    setTimeout(InGameDialog, 10);   
                    rerolls=0
                ...
                if (round == 3){
                    ...
                    if (gameOverScore()>=0){
                        ...
                        coins=coins*2+1
                        if (coins>20&&currentScene==10){
                            currentScene=11
                        }else{
                            alert("Чтобы перейти на следующий этап предется накопить сумму денег, играй с джо и покупай ништяки если хочешь победить")
                        }
                        

                    }else{
                        CurrentDialog = [{txt:"Ну ничего, парень, бывает. Ты главное не унывай и играй не на последние деньги.", name:"Просто Фил"}]
                        coins=Math.floor(coins/2)+1
                    }
                    filFirst=false
                    InGameDialog()
                    drawScene(currentScene)
...
function drawScene(scene){
    ...
    let linaNPC = new Image(width,height)
    let End = new Image(width,height)
    ...
    linaNPC.src = "img/npc/lina.png"
    End.src = "img/GG_fon.png"
    ...
    //* ----------------------------------------------------------------
        ...
        {txt:"Уф-ф-ф, хорошая. Беру! По 20 монет за мешок.", name:"Дядя Гуго"},
        ...
        {txt:"Ох, ты-ж…", name:"Герой (главный)"},
        ...
        {txt:"Неужто сон? Ох я бы сейчас с той Королевой… Хотя да, далеко мне до неё. Но хотя бы с той рыжей, горячей…", name:"Герой (главный)"},
        {txt:"И вспомнил он разом как проиграл все деньги, телегу и лошадь обольстительнице.", name:"Рассказчик"},
        {txt:"Ох ну как я так то, а? Ой зло эти бабы… Ой дурак… И как я теперь бате то в глаза посмотрю? А маме? Ох, чёрт, чёрт, чёрт…", name:"Герой (главный)"},
        {txt:"Чё звал?", name:"Чёрт"},
        {txt:"Только было начал парень жаловаться на свою горькую судьбу, как напротив него, за столом оказался чёрт.", name:"Рассказчик"},
        {txt:"Что? Ты кто?", name:"Герой (главный)"},
        {txt:"Бегемот.", name:"Чёрт"},
        {txt:"Где!?", name:"Герой (главный)"},
        {txt:"Не поверил своим глазами наш герой и давай испуганно озираться.", name:"Рассказчик"},
        {txt:"Я тебе щас! Откуда ты вообще знаешь кто это, деревенщина необразованная?", name:"Чёрт"},
        {txt:"Я когда ребятёнком был, мне мама читала чудную книжку, по наследству доставшуюся, про дальние страны. Так там было такое жуткое животное - бе-ге-мот. Во век не забуду. Зубищи, как мама читала, с локоть размером. Здоровыи - как телега… да не, даже как две. И при этом бегает чуть помедленнее лошади. Ух-х-х, страшилище наверное...", name:"Герой (главный)"},
        {txt:"Сам ты страшилище. Бегемот не чудище, а гордое животное. Поэтому его и назвали в честь меня!", name:"Чёрт"},
        {txt:"Да какой ты бегемот… так, чёрт обыкновенный…", name:"Герой (главный)"},
        ...
        {txt:"А ещё я помню, всё из той же книжки, рассказ про араба, который обхитрил султана и забрал у него полцарства…", name:"Герой (главный)"},
        {txt:"Всё, пошли пьяные истории…", name:"Чёрт"},
        {txt:"Так это к чему. Точно знаю, что как только опохмелюсь, то по старой доброй костянской традиции, верну себе и телегу, и лошадь, и деньги. А потом, чего уж там, и у Короля полцарства отыграю, как тот ар…", name:"Герой (главный)"},
        {txt:"А-ХА-ХА-ХА!!! ТЫ!? А-ХА-ХА-ХА-ХА-ХА!!! ДЕРЕВЕНЩИНА, ДА ПО КОСТЯНСКОЙ ТРАДИЦИИ И ПОЛЦАРСТВА!? ДА НЕ-ВЕ-РЮ!!!", name:"Чёрт"},
        {txt:"Вся таверна тут же обернулась в сторону нашего героя, но осторожный чёрт успел исчезнуть. Спустя пару секунд, все потеряли к незадачливому игроку и пьянице весь интерес. В этот же момент чёрт снова сел за столик.", name:"Рассказчик"},
        {txt:"А вот спорим, на мою неиссякаемую кружку пива, что ты не сможешь по костянской традиции, получить полцарства?", name:"Чёрт"},
        {txt:"Как неиссякаемую?", name:"Герой (главный)"},
        {txt:"А вот так!", name:"Чёрт"},
        ...
        {txt:"Да куда!? Стой, дурак!!!", name:"Герой (главный)"},
        {txt:"Попытался было наш герой потянуться к этому Иуде...", name:"Рассказчик"},
        {txt:"Вот выиграешь в споре, тогда и будешь делать с этой кружкой и её пивом - что хочешь.", name:"Чёрт"},
        {txt:"И исчезла кружечка.", name:"Рассказчик"},
        {txt:"Ну что, спорим?", name:"Чёрт"},
        {txt:"Спорим!", name:"Герой (главный)"},
        {txt:"И скрепил с чертом спор крепким мужским рукопожатием.", name:"Рассказчик"},
        {txt:"Вот именно так и оказался наш герой в таверне “Кость в горле” без денег, с ноющим затылком, на вонючем полу, но с твёрдым желанием измениться и выиграть спор у черта.", name:"Рассказчик"},]
        ...
        function click(x,y){
            if (collision(x,y,100,85,130,200)){
            ...
            else if (collision(x,y,0,250,230,300)){
                if (!talkNishii)
                ...
                {txt:"В то же время, мудрый Нищий лишь трагически схватился за голову.", name:"Рассказчик"},]
                    ...
                    CurrentDialog=[{txt:"Возможно стоит поговорить с трактирщиком", name:"Рассказчик"},]
                }
                dialog()
                talkNishii=true
            }
            ...
            else if (collision(x,y,470,215,200,200)){
                console.log("dor")
                ShopOpen(1)
            }
            else if (collision(x,y,240,165,120,230)){
                ...
                if (coins>=1&&coins<=10){
                    ...
                    CurrentDialog=[
                        ...
                        {txt:"Вижу тебя совсем жизнь потр*Ик*пала, держи монетку",name:"Щедрый Джо"},]
                    dialog()
                }else{
                    CurrentDialog=[
                        {txt:"Привет, вижу ты обогатился",name:"Джо"},
                        {txt:"Удачного дня, не хватит мне на ставку",name:"Джо"},]
                    dialog()
                }
            }
        ...
        function click(x,y){
            if (collision(x,y,100,85,130,200)){
            ...
            else if (collision(x,y,240,165,180,230)){
            ...
            else if (collision(x,y,550,300,400,340)){
                if (filFirst){
                ...
                {txt:"Ха-ха, так это же я! Ну, коль есть на что играть и настроен будешь серьёзней, то давай. Испытаем тебя. Сейчас только с одним другом сыграю...", name:"Фил"},]
                    ...
                    CurrentDialog = [{txt:"Реванш?", name:"Просто Фил"}]
                }
                DiceGame(3)
                // firstBarShop=false
            }
        ...
        ctx.drawImage(tavern,0,0)
        // ctx.drawImage(dadNPC,200,165)
        ctx.drawImage(s1NPC,890,87)


        if (collision(x,y,890,87,400,340)){
        ...
        ctx.drawImage(linaNPC,600,200)
        function click(x,y){
            if (collision(x,y,600,200,400,340)){
        ...
        ctx.drawImage(tavern,0,0)
        ctx.drawImage(dadNPC,200,165)
        ctx.drawImage(s1NPC,900,20)
        ctx.drawImage(linaNPC,600,200)
        function click(x,y){
            if (collision(x,y,680,280,130,300)){
                ...
                DiceGame(4)
            }else if (collision(x,y,900,20,500,300)){
                ShopOpen(0)
            }else if (collision(x,y,240,205,120,120)){
                if (coins<30){
                    CurrentDialog = [{txt:"Пришёл набраться опыта? Или денег?",name:"Джо"}]
                    DiceGame(2)
                }
                else
                    alert("Джо больше не желает проигрывать деньги")
            }else if (collision(x,y,470,215,200,200)){
                console.log("dor")
                ShopOpen(1)
            }
...
function updateInv(){
    ...
    inv.font = "20px serif";
    inv.fillText("Монеток: "+coins,5,25,invWidth-12)
