        ...
        function click(x,y){
            ...
            if (collision(x,y,235,210,810,300)){
                ...
                if (round == 0){
                    ...
                    updateInv()
                    isDialog=true
                    if (currentScene==9&&coins>3&&talkNishii&&!firstBarShop){
                        currentScene=10
                    }
                    setTimeout(InGameDialog, 100);
...
function drawScene(scene){
    ...
    //* ----------------------------------------------------------------
        ...
        ctx.drawImage(linaNPC,600,200)
        function click(x,y){
            if (collision(x,y,600,200,100,100)){
                ...
                DiceGame(4)
            }else if (collision(x,y,500,300,100,100)){
                Shop(0)
            }else if (collision(x,y,200,165,100,100)){
                DiceGame(1)
            }else if (collision(x,y,470,215,200,200)){
                console.log("dor")
                ShopOpen(1)
